  ...
  return (
    <div className={`offcanvas offcanvas-start ${isMobile ? (isHidden ? "" : "show") : "show"} ${isToggled ? `bg-customdark` : `bg-light`}`} tabIndex={-1} id="offcanvas" aria-labelledby="offcanvasLabel" style={{"borderRight": "none"}} >
        <div className="offcanvas-header">
            <button className={`d-flex align-items-center btn ${isToggled ? "btn-dark-custom" : "btn-light"} col-12 mt-4 fs-5`} style={{fontFamily: "Sohne", textAlign: "left"}}>
              <Image 
                  src='/ramsay-pfp.png'
                  alt='ramsay-pfp'
                  width={50}
              ...
              <button type="button" className={`btn-close mb-5 text-reset ${isMobile ? "" : "d-none"}`} data-bs-dismiss="offcanvas" aria-label="Close" onClick={handleHideSidebar}></button>
        </div>
